...
class Runmcx():
    ...
    def set_conditions(self, position): # , rotation, opt_tumour, opt_normal):
    ...
    def run_mcx(self, position): # , rotation, opt_tumour, opt_normal):
        self.set_conditions(position) # , rotation, opt_tumour, opt_normal)
